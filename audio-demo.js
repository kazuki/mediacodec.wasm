...
async function benchmark(file, opus_cfg) {
    ...
    msg.appendChild(document.createTextNode((audio_info.sampling_rate / 1000).toString() + 'kHz ' +
        audio_info.num_of_channels.toString() + 'ch ' +
        duration.toFixed() + 's'));
    result.appendChild(msg);
    msg = document.createElement('div');
    msg.appendChild(document.createTextNode('read:' + (read_end - read_start) + 'ms'));
    result.appendChild(msg);
    ...
    msg = document.createElement('div');
    msg.appendChild(document.createTextNode('encode:' + encode_time.toFixed() + 'ms (' +
    ...
    msg = document.createElement('div');
    msg.appendChild(document.createTextNode('decode:' + decode_time.toFixed() + 'ms (' +
